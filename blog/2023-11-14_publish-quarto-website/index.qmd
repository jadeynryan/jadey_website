...
Another benefit of Netlify are the integrations with different web tools. The only one I'm using so far is [Google's Lighthouse tool](https://developer.chrome.com/docs/lighthouse/overview/), which helps me abide by my [accessibility commitment](../accessibility.html).
