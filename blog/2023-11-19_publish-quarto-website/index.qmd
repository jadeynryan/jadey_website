...
Optionally, we can turn this setting off so that you have to click `Publish` to send a deployment to our public site. Go to `Deploys` \> `Lock to stop auto publishing`. 
