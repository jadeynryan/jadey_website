...
This is meant to be a follow-along tutorial. Click on any of the images to see it full screen.
...
After the `_site` folder uploaded, a `Deploy success!` message displayed. Notice Netlify generated a random domain name. I'll change this in the next step.
