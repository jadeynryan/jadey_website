...
![](assets/img/wsda.png){width="80px" fig-alt="Washington State Department of Agriculture logo"} [Washington State Department of Agriculture]{.h3}
...
-   Use R, Python, and ArcGIS to develop data products and decision support tools such as Shiny web applications, ArcGIS dashboards, and ArcGIS Experience Builder web applications.
...
![](assets/img/plu.gif){width="60px" fig-alt="Pacific Lutheran University logo"} [Pacific Lutheran University]{.h3}
...
![](assets/img/tacoma-water.jpeg){width="80px" fig-alt="Tacoma Water logo"} [Tacoma Water]{.h3}
...
![](assets/img/omi.gif){width="60px" fig-alt="Ocean Mammal Institute logo"} [Ocean Mammal Institute]{.h3}
...
![](assets/img/msu.png){width="80px" fig-alt="Montana State University logo"} [Montana State University]{.h3}
...
Tacoma Water 
    -   Certificate of Recognition for Excellence in Inorganic Chemistry
American Chemical Society
    -   $60,000 Provost Merit Scholarship 
Pacific Lutheran University

![](assets/img/tcc.jpeg){width="60px" fig-alt="Tacoma Community College logo"} [Tacoma Community College]{.h3}
...
![](assets/img/dsh.png){width="60px" fig-alt="Data Science Hangout logo"} [Posit Data Science Hangout](https://posit.co/data-science-hangout/)

![](assets/img/r4ds.jpeg){width="60px" fig-alt="R4DS logo"} [R4DS Learning Community](https://rfordatasci.com/)

![](assets/img/wig.jpeg){width="60px" fig-alt="Women in GovTech logo"} [Women in GovTech](https://women-in-govtech.github.io/)

![](assets/img/rladiesseattle.gif){width="60px" fig-alt="R-Ladies Seattle logo"} [R-Ladies Seattle](https://rladiesseattle.org/)

![](assets/img/seattleuser.webp){width="60px" fig-alt="Seattle useR Group"} [Seattle useR Group](https://www.meetup.com/seattle-user/)
...
**Ryan, J.N.** 2021. Organophosphate insecticide mixtures in Washington surface waters. Virtual North American 42nd Annual Meeting, Society of Environmental Toxicology and Chemistry.

**Ryan, J.N.** 2021. Organophosphate insecticide mixtures in Washington surface waters. Virtual Annual Water Resources Conference, American Water Resources Association.

## {{< fa user-gear >}} Skills

[Software and Programming]{.h5}

-   Proficient in R, Microsoft Office, ArcGIS (Pro, Dashboards, and Experience). 
